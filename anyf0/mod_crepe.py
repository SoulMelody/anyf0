# from https://github.com/ailia-ai/ailia-models/blob/master/audio_processing/crepe/crepe.py
import functools
...
def predict(
    ...
    for frames in generator:
        ...
        probabilities = infer(frames, session)
...
def preprocess(
    ...
    if sample_rate != SAMPLE_RATE:
        ...
        raise ValueError(
            f"sample_rate must be {SAMPLE_RATE} Hz for Crepe. "
